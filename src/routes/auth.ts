...
AuthRoute.get("/", async (req, res) => {
    if (req.query.code) {
        ...
        let scopes = ["user:write:chat", "user:read:chat", "chat:read", "chat:edit", "user:bot", "channel:bot", "moderator:manage:announcements", "moderator:manage:shoutouts", "moderator:read:followers", "moderator:manage:banned_users", "moderator:manage:chat_messages", "moderator:read:chatters","editor:manage:clips"];
